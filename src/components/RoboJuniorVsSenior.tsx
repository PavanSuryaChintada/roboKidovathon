          ...
          <div className="card-light p-6 sm:p-8 flex flex-col justify-between border-t-4 border-t-[#0052FF]">
            <div>
              <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-5">
                <span className="font-extrabold text-2xl uppercase text-[#0B1020]">
                  JUNIOR DIVISION
                </span>
              ...
              <div className="space-y-3 font-inter text-xs sm:text-sm text-[#334155]">
                <div className="p-3.5 bg-[#F8FAFC] border border-slate-200 rounded-lg flex justify-between items-center">
          ...
          <div className="card-light p-6 sm:p-8 flex flex-col justify-between border-t-4 border-t-[#0B1020]">
            <div>
              <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-5">
                ...
                <span className="bg-slate-100 text-[#0B1020] font-mono font-bold text-xs px-3 py-1 rounded-full uppercase border border-slate-300">
                  AGE 15 & ABOVE
                </span>
              </div>
