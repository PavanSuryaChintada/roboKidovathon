...
import { ArrowLeft, ShieldCheck, Trophy, ArrowRight, BookOpen, Scale, Repeat } from 'lucide-react';
      ...
      <div className="max-w-[1440px] mx-auto space-y-16">
        ...
        >
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-600 font-light max-w-2xl leading-relaxed">
            Arena: 2.44 m × 1.22 m. Both leagues play 1 team vs 1 team, 3-minute matches, 3–4 students per team. Move as many balls as possible from your side into the opponent's side before time ends.
          </p>
        </motion.div>
