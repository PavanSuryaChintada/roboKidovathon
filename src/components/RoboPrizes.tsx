...
export const RoboPrizes: React.FC = () => {
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
      <div className="card-event p-6 sm:p-12 text-center border border-white/15">
        ...
        <p className="text-xs sm:text-sm font-inter text-slate-300 max-w-lg mx-auto mb-8 text-balance">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
          {/* 2nd Place */}
          <div className="p-5 bg-white/5 border border-white/10 rounded-xl text-center space-y-1.5 order-2 md:order-1">
          ...
          {/* 1st Place Peak */}
          <div className="p-6 bg-[#0052FF]/20 border-2 border-[#0052FF] rounded-2xl text-center space-y-2 order-1 md:order-2 shadow-2xl transform md:-translate-y-3">
          ...
          {/* 3rd Place */}
          <div className="p-5 bg-white/5 border border-white/10 rounded-xl text-center space-y-1.5 order-3">
