      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-10 gap-4">
          ...
          <button
            ...
            className="btn-event-secondary-light text-xs px-5 py-2.5 rounded-lg whitespace-nowrap"
          >
            VIEW RULEBOOK →
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Track 1: ROBO-SPRINT */}
          <div className="card-light p-6 sm:p-8 flex flex-col justify-between border-t-4 border-t-[#0052FF]">
            <div className="space-y-4">
              ...
              <h3 className="text-3xl font-extrabold text-[#0B1020]">
                Robo-Sprint
              </h3>
              ...
              <div className="my-4 flex justify-center bg-[#F8FAFC] p-6 rounded-xl border border-slate-200">
                <RoboSprintBot className="w-44 sm:w-52" />
              </div>

              <div className="space-y-2.5 text-xs sm:text-sm font-inter text-[#334155] font-medium border-t border-slate-200 pt-4">
                <p>
            ...
            <button
              onClick={() => onNavigate('challenges')}
              className="mt-8 w-full btn-event-primary py-3.5 text-xs sm:text-sm rounded-xl text-center whitespace-nowrap"
            >
              SELECT ROBO-SPRINT →
            </button>
          </div>
          ...
          <div className="card-light p-6 sm:p-8 flex flex-col justify-between border-t-4 border-t-[#0B1020]">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="bg-slate-100 text-[#0B1020] border border-slate-300 text-xs font-mono font-bold px-3 py-1 rounded-full uppercase">
